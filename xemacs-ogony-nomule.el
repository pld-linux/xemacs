...
(define-key global-map 'Aogonek
  (function (lambda() (interactive "*") (insert 161))))
(define-key global-map 'aogonek 
  (function (lambda() (interactive "*") (insert 177))))
(define-key global-map 'Cacute 
  (function (lambda() (interactive "*") (insert 198))))
(define-key global-map 'cacute 
  (function (lambda() (interactive "*") (insert 230))))
(define-key global-map 'Eogonek 
  (function (lambda() (interactive "*") (insert 202))))
(define-key global-map 'eogonek 
  (function (lambda() (interactive "*") (insert 234))))
(define-key global-map 'Lstroke 
  (function (lambda() (interactive "*") (insert 163))))
(define-key global-map 'lstroke 
  (function (lambda() (interactive "*") (insert 179))))
(define-key global-map 'Nacute 
  (function (lambda() (interactive "*") (insert 209))))
(define-key global-map 'nacute 
  (function (lambda() (interactive "*") (insert 241))))
(define-key global-map 'Sacute 
  (function (lambda() (interactive "*") (insert 166))))
(define-key global-map 'sacute 
  (function (lambda() (interactive "*") (insert 182))))
(define-key global-map 'Zacute 
  (function (lambda() (interactive "*") (insert 172))))
(define-key global-map 'zacute 
  (function (lambda() (interactive "*") (insert 188))))
(define-key global-map 'Zabovedot 
  (function (lambda() (interactive "*") (insert 175))))

(define-key global-map 'zabovedot
  (function (lambda() (interactive "*") (insert 191))))

(define-key global-map 'unknown-keysym-0x1F3
  (function (lambda() (interactive "*") (insert 243))))

(define-key global-map 'unknown-keysym-0x1D3
  (function (lambda() (interactive "*") (insert 211))))

(define-key global-map 'ISO_Left_Tab [(shift tab)])
